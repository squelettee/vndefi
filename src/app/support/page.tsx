...
const copy: Record<string, { title: string; body: string[]; back: string }> = {
  fr: {
    title: "Support",
    body: [
      "Pour toute question, suggestion ou demande, écrivez à baptiste.gresse@proton.me.",
    ],
  ...
  en: {
    title: "Support",
    body: [
      "For any question, suggestion or request, email baptiste.gresse@proton.me.",
    ],
    back: "← Back to home",
  },
  vi: {
    title: "Hỗ trợ",
    body: [
      "Mọi câu hỏi, đề xuất hoặc yêu cầu, vui lòng gửi email tới baptiste.gresse@proton.me.",
    ],
