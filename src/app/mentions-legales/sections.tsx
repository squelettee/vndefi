    ...
    blocks: [
      {
        ...
        p: [
          ...
          "Adresse e‑mail : baptiste.gresse@proton.me",
        ],
      },
      {
        h: "Statut",
      ...
      },
      {
        h: "Responsabilité",
        p: [
          "Le site VNDeFi.asia a pour unique objectif de fournir des informations éducatives sur les paiements en crypto‑monnaie au Vietnam. Il ne constitue ni un service financier, ni une plateforme d’échange, ni une entreprise liée à une entité financière. VNDeFi n’est ni affilié, ni approuvé par aucune société mentionnée. Les informations présentées sont fournies à titre indicatif et peuvent être modifiées à tout moment.",
        ],
      },
      {
        h: "Protection des données personnelles",
        p: [
          "Aucune donnée personnelle n’est collectée sans consentement explicite. Des outils d’analyse anonymes peuvent être utilisés pour améliorer l’expérience utilisateur. Pour toute question ou demande de suppression de données, contactez : baptiste.gresse@proton.me.",
        ],
      },
      {
        h: "Crédits",
        p: ["Création, développement et design : Baptiste Gresse."],
      },
      {
        h: "Contact",
        p: [
          "Pour toute demande concernant le site ou le projet pilote, vous pouvez écrire à baptiste.gresse@proton.me.",
        ],
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        p: [
          ...
          "Email address: baptiste.gresse@proton.me",
        ],
      },
      {
        h: "Status",
      ...
      },
      {
        h: "Liability",
        p: [
          "VNDeFi.asia provides educational information about crypto payments in Vietnam. It is not a financial service, an exchange platform, or a company affiliated with any financial entity. VNDeFi is independent and not affiliated with or endorsed by any of the companies mentioned. Information is provided for guidance only and may change at any time.",
        ],
      },
      {
        h: "Personal Data",
        p: [
          "No personal data is collected without explicit consent. Anonymous analytics tools may be used to improve user experience. For any request or data deletion, contact: baptiste.gresse@proton.me.",
        ],
      },
      {
        h: "Credits",
        p: ["Creation, development and design: Baptiste Gresse."],
      },
      {
        h: "Contact",
        p: [
          "For any inquiries regarding the site or the pilot project, email baptiste.gresse@proton.me.",
        ],
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        p: [
          ...
          "Email: baptiste.gresse@proton.me",
        ],
      },
      {
        h: "Trạng thái",
      ...
      },
      {
        h: "Trách nhiệm",
        p: [
          "VNDeFi.asia chỉ cung cấp thông tin giáo dục về thanh toán crypto tại Việt Nam. Đây không phải dịch vụ tài chính, sàn giao dịch hay công ty liên kết với bất kỳ tổ chức tài chính nào. VNDeFi không liên kết hoặc được bảo trợ bởi aucune société mentionnée. Thông tin chỉ mang tính tham khảo và có thể thay đổi bất cứ lúc nào.",
        ],
      },
      {
        h: "Dữ liệu cá nhân",
        p: [
          "Không thu thập dữ liệu cá nhân nếu không có sự đồng ý rõ ràng. Có thể sử dụng công cụ phân tích ẩn danh để cải thiện trải nghiệm người dùng. Mọi yêu cầu hoặc xoá dữ liệu, vui lòng liên hệ: baptiste.gresse@proton.me.",
        ],
      },
      {
        h: "Ghi công",
        p: ["Thiết kế, phát triển: Baptiste Gresse."],
      },
      {
        h: "Liên hệ",
        p: [
          "Mọi thắc mắc về trang web hoặc dự án thử nghiệm, vui lòng gửi email tới baptiste.gresse@proton.me.",
        ],
      },
    ],
  },
