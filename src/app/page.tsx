...
const translations = {
  en: {
    ...
    b1Desc: "Pay instantly using QR codes — your wallet handles the VND transfer.",
    b2Title: "Convenient everywhere",
    b2Desc: "Just scan the bank QR at local shops — no need for a local card or cash.",
    b3Title: "No card limits",
    b3Desc: "Skip international card declines and travel spending limits.",
    b4Title: "Seamless with Bitget",
    b4Desc: "Optimized for Bitget Wallet today, with support for more wallets coming soon.",
    ...
    s2Title: "Set up your wallet.",
    s2Desc: "Create your wallet and add crypto funds in seconds.",
    s3Title: "Scan the bank QR at checkout.",
    s3Desc: "Most Vietnamese shops display a local bank QR code.",
  ...
  fr: {
    ...
    b1Desc: "Payez instantanément via QR — votre wallet gère le virement en VND.",
    b2Title: "Pratique partout",
    b2Desc: "Scannez le QR bancaire en magasin — pas besoin de carte locale ni d’espèces.",
    b3Title: "Sans limites de carte",
    b3Desc: "Évitez les refus de cartes internationales et les plafonds de dépense en voyage.",
    b4Title: "Fluide avec Bitget",
    b4Desc: "Optimisé pour Bitget Wallet aujourd’hui, d’autres wallets arrivent bientôt.",
    ...
    s2Title: "Configurez votre wallet.",
    s2Desc: "Créez votre wallet et ajoutez des fonds en crypto en quelques secondes.",
    s3Title: "Scannez le QR bancaire à la caisse.",
    s3Desc: "La plupart des commerces au Vietnam affichent un QR bancaire local.",
  ...
  vi: {
    ...
    b1Desc: "Thanh toán tức thì bằng mã QR — ví của bạn xử lý chuyển khoản VND.",
    b2Title: "Tiện lợi ở khắp nơi",
    b2Desc: "Chỉ cần quét mã QR ngân hàng tại cửa hàng — không cần thẻ nội địa hay tiền mặt.",
    b3Title: "Không bị giới hạn thẻ",
    b3Desc: "Bỏ qua việc thẻ quốc tế bị từ chối và các hạn mức chi tiêu khi du lịch.",
    b4Title: "Mượt mà với Bitget",
    b4Desc: "Tối ưu cho Bitget Wallet hiện tại, sẽ sớm hỗ trợ thêm nhiều ví.",
    ...
    s2Title: "Thiết lập ví của bạn.",
    s2Desc: "Tạo ví và nạp crypto chỉ trong vài giây.",
    s3Title: "Quét mã QR ngân hàng tại quầy thanh toán.",
    s3Desc: "Đa số cửa hàng ở Việt Nam hiển thị mã QR ngân hàng nội địa.",
