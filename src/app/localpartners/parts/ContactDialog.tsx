...
export function ContactDialog({
  ...
  const isValid = useMemo(
    () => company.trim().length > 1 && email.trim().length > 3 && consent,
    [company, email, consent]
  );
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-2">
            <Label htmlFor="dlg-wa">
              {whatsappLabel ?? "WhatsApp / Zalo (optional)"}
            </Label>
            <Input
              id="dlg-wa"
              type="tel"
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="dlg-consent" className="text-sm">
              {consentLabel}
            </Label>
          </div>
